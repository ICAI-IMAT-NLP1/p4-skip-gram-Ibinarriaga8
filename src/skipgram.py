...
class SkipGramNeg(nn.Module):
    ...
    def __init__(self, n_vocab: int, n_embed: int, noise_dist: torch.Tensor = None):
        ...
        #in_embed: center words
        #out_embed: context words
        super().__init__()
        self.n_vocab: int = n_vocab #number of words in the vocabulary
        self.n_embed: int = n_embed #dimension of the embedding
        self.noise_dist: torch.Tensor = noise_dist

        # Define embedding layers for input and output words
        # TODO

        #embedding layers initialized with uniform distribution
    ...
    def forward_input(self, input_words: torch.Tensor) -> torch.Tensor:
        ...
        #input_vectors: representing indices of the input words in the vocabulary
        #returns input vectors (center words)converted into embeddings
    ...
    def forward_noise(self, batch_size: int, n_samples: int) -> torch.Tensor:
        ...
        #samples from noise_dist with replacement batch_size * n_samples random samples; will be converted to (batch_size, n_samples) shape
